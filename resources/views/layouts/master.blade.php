...
<body id="page-top">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <select class="btn btn-info" onchange="changeLanguage(this.value)" >
              ...
              <option {{session()->has('lang_code')?(session()->get('lang_code')=='ar'?'selected':''):''}} value="ar">العربية</option>
  ...
  <!-- Logout Modal-->
  <div class="modal fade bg-light" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <!-- <div class="modal-content"> -->
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Ready to Leave?</h5>
          <button class="close btn-warning" type="button" data-dismiss="modal" aria-label="Close">
